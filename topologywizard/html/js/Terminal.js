...
lang.extend(WireIt.TerminalProxy, util.DDProxy, {
 ...
 /*     for(var i = 0 ; i < this.terminal.wires.length ; i++) {
      ...
      //dont allow more than one link/wire per port
      if(term2.wires.length > 0)
      {
      	return;
      }
      ...
      if( tgtTerm.options.nMaxWires == 1) {
         ...
         w.redraw();
      	...
      	//alert("tgtTerm.wires.length = " + tgtTerm.wires.length + "and nMaxWires = " + tgtTerm.options.nMaxWires );
         var w = new WireIt.Wire(term1, term2, parentEl, term1.options.wireConfig);
         w.redraw();
      }
      /*else {
...
WireIt.Terminal = function(parentEl, options, container) {
    ...
    */
    ...
    this.portID = null; 
    this.Capacity  = null;
    this.maxResCapacity = null;
    this.minResCapacity = null;
...
/*   this.eventBubbleClickTerminal = new util.CustomEvent("eventBubbleClickTerminal");
   
   Event.addListener(this, "click", this.doProcessTerminalClick, this, true);*/
...
WireIt.Terminal.prototype = {
   ...
   /*doProcessTerminalClick:function()
   {
   	
   		this.eventBubbleClickTerminal.fire(this);		
   }*/
   ...
   setOptions: function(options) {
      ...
      this.offsetPos = options.offsetPosition;
      this.options.alwaysSrc = lang.isUndefined(options.alwaysSrc) ? false : options.alwaysSrc;
      this.options.ddConfig = options.ddConfig || {};
      
      this.portID = options.portID || "port-";
      this.Capacity = options.Capacity || "1000000000";
      this.maxResCapacity = options.maxResCapacity || "1000000000";
      this.minResCapacity = options.minResCapacity || "1000000";
      this.granularity = options.granularity || "1000000";
      
   },
   
   getPortOffset: function()
   {
...
//@B@S
   removePort:function(){
    ...
    this.container.removeTerminal(this);
