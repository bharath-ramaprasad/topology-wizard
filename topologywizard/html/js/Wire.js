...
WireIt.Wire = function( terminal1, terminal2, parentEl, options) {
    ...
    /**
     * Initialize the connector (link) properties
     */
     
     this.linkid = null;
     this.remoteLinkId = null;
     this.trafficEngineeringMetric = null;
     this.switchingcapType = null;
     this.encodingType = null;
     this.capability = null;
     this.interfaceMTU = null;
     this.vlanRangeAvailability = null;
...
YAHOO.lang.extend(WireIt.Wire, WireIt.CanvasElement, {
   ...
   setOptions: function(options) {
      ...
      //setting the name of the connector
      
      this.name = options.name || 'Link';
      
      //retrieveing values and setting defaults
       
      
      //var linkProperties = options.linkProps || null;
      
      this.linkid = 'link1';
      this.remoteLinkId = 'link1';
	  this.trafficEngineeringMetric = '100';
      this.switchingcapType =  'l2sc';
      this.encodingType =  'packet';
      this.capability = 'l2sc-'; 
      this.interfaceMTU =  '9000';
      this.vlanRangeAvailability =  '3000-4000';
	

      
/*      this.linkid = YAHOO.lang.isUndefined(linkProperties.linkid)? 'link1' : linkProperties.linkid; 
      this.remoteLinkId = YAHOO.lang.isUndefined(linkProperties.remoteLinkId)? 'link1' : linkProperties.remoteLinkId ; 
      this.trafficEngineeringMetric = YAHOO.lang.isUndefined(linkProperties.trafficEngineeringMetric)? '100' : linkProperties.trafficEngineeringMetric ;
      this.switchingcapType = YAHOO.lang.isUndefined(linkProperties.switchingcapType)? 'optional' : linkProperties.switchingcapType;
      this.encodingType = YAHOO.lang.isUndefined(linkProperties.encodingType)? 'packet' : linkProperties.encodingType;
      this.capability = YAHOO.lang.isUndefined(linkProperties.capability)? 'optional' : linkProperties.capability; 
      this.interfaceMTU = YAHOO.lang.isUndefined(linkProperties.interfaceMTU)? '9000' : linkProperties.interfaceMTU;
      this.vlanRangeAvailability = YAHOO.lang.isUndefined(linkProperties.vlanRangeAvailability)? '2,3,55-100,200-4094' : linkProperties.vlanRangeAvailability;*/
   ...
   getValue : function()
   {
   		...
   		linkInfo.linkid = this.linkid;
   		linkInfo.remoteLinkId = this.remoteLinkId;
   		linkInfo.trafficEngineeringMetric = this.trafficEngineeringMetric;
   		linkInfo.switchingcapType = this.switchingcapType;
   		linkInfo.encodingType = this.encodingType;
   		linkInfo.capability = this.capability;
   		linkInfo.interfaceMTU = this.interfaceMTU;
   		linkInfo.vlanRangeAvailability = this.vlanRangeAvailability;
   ...
   setValue :  function(linkInfo)
   {
		 this.linkid = linkInfo.linkid;
   		 this.remoteLinkId = linkInfo.remoteLinkId;
   		 this.trafficEngineeringMetric = linkInfo.trafficEngineeringMetric;
   		 this.switchingcapType = linkInfo.switchingcapType;
   		 this.encodingType = linkInfo.encodingType;
   		 this.capability = linkInfo.capability;
   		 this.interfaceMTU = linkInfo.interfaceMTU;
   		 this.vlanRangeAvailability = linkInfo.vlanRangeAvailability; 
   },
